  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-gray-500 text-center mb-5">We are happy to see you again!</div>
        <div className="mb-6">
          <div className="mb-2 font-semibold text-xs text-gray-600 text-left">CONTINUE WITH</div>
          <button
